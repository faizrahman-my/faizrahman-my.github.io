      ...
      <div className='p-5 font-khand'>
        ...
        <div className='min-md:flex'>
          <form action="https://formspree.io/f/moqgqeja" method="POST" className='mt-20 min-md:w-3/4'>
            <input type="text" name="name" placeholder='name' className='w-full input input-bordered mb-4'/>
            <br />
            <input type="email" name="email" placeholder='email' className='w-full input input-bordered mb-4' />
            <br />
            <input type="text" name="subject" placeholder='subject' className='w-full input input-bordered mb-4'/>
            <br />
            <textarea name="message" cols="30" rows="10" placeholder='message' className='w-full textarea textarea-bordered mb-4'></textarea>
            <br />
            <input type="submit" value="submit" className='w-full  text-web-text2 bg-web-back2 min-sm:hover:bg-web-back3 rounded-xl py-2 cursor-pointer' />
          </form>
          <div className='grid min-md:w-1/4 max-md:grid-cols-2'>
            ...
            <div className='grid min-md:content-start max-md:justify-start'>
              <a href="https://www.linkedin.com/in/faizrahman-my/" target="_blank" className='max-md:px-4 py-2 mx-2 my-5 bg-web-back1 border-2 border-web-back2 rounded-xl min-md:ml-10'>
                <div className='flex items-center min-md:px-2'>
